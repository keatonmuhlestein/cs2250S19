 ...
 *
 *        Version:  1.0
 *        Created:  04/18/2019 09:03:22 AM
 *       Revision:  none
 *       Compiler:  gcc main.cpp -o main.out -lm
 *          Usage:  ./main.out
 *
...
void DeleteSong(PlaylistNode*& headNode, PlaylistNode*& tailNode, PlaylistNode*& prevNode)
{
    ...
    if (songNode == 0 ) 
    {
        cout << "ERROR: songPosition provided by user is invalid" << endl;
        // Do nothing
    }
    else 
    {
     ...
     /*   if (songPosition == 1) //list head is removed
        {
